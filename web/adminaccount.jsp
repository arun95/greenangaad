		...
		<div class="header-main">
	        ...
	        <!---->
			   ...
			   <div class="header-right">
				   <div class="logo">
				   	   <h1><a href="adminaccount.jsp">Admin</a></h1>
				   </div>
...
<div class="top-navg-main">
	<div class="container">
	    <div class="top-navg">
				...
				<ul class="res">
				    <li><a href="adminaccount.jsp" class="active hvr-sweep-to-bottom">Home</a></li> 
					<li><a class="hvr-sweep-to-bottom" href="adminmsg.jsp">Message</a></li> 
					<li><a class="hvr-sweep-to-bottom" href="userdisplay_1.jsp">User</a></li> 
					<li><a class="hvr-sweep-to-bottom" href="sellerdisplay_1.jsp">Seller</a></li> 
					<li><a class="hvr-sweep-to-bottom" href="logout.jsp">Logout</a></li> 
				 </ul>
